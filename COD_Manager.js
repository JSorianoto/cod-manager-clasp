...
function onOpen() {
  ...
  const menu = ui.createMenu('📦 COD Manager')
    ...
    .addSubMenu(ui.createMenu('🛡️ Análisis de Fraude')
      .addItem('🔍 Analizar Nuevos Pedidos', 'analizarNuevosPedidosHistorico')
      .addItem('🔄 Re-analizar Todos', 'reAnalizarTodosPedidosHistorico')
      .addItem('📈 Estadísticas de Fraude', 'mostrarEstadisticasFraude')
      .addItem('🚨 IPs Más Sospechosas', 'mostrarIPsSospechosas')
      .addItem('🧹 Limpiar Cache IPs', 'limpiarCacheIPsUI')
      .addItem('📊 Estadísticas Cache IPs', 'mostrarEstadisticasCache'))
    .addSeparator()
